...
export function CItemDisplay({item, onChangeLocation, location, onRemoveItem} : {item: IItem, shelf: string, onChangeLocation: Function, location:Array<string>, onRemoveItem: Function}) {
    return (
...
export function CItemSmallDisplay({item, onChangeLocation, location} : {item: IItem, location: Array<string>, onChangeLocation: Function}) {
    return(
            <img src={item.thumbnailURL} className="card-img small" onClick={()=>{onChangeLocation([...location, item.id], View.BOOK)}}/>
        )
}

export function CShelfDisplay({collection, items, onChangeLocation, location,  onRemoveCollection, onEditCollection} : {collection: ICollection, items: Map<string, IItem>, onChangeLocation: Function, location:string[], onRemoveCollection: Function, onEditCollection: Function}) {
    return(
